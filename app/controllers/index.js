...
var specs = [
	...
	{spec:{
		name: 'view3', pos: [5,6], span: [1,1], props: {backgroundColor: 'green'}
	...
	{spec:{
		name: 'view4', pos: [6,5], span: [1,1], props: {backgroundColor: 'silver'}
	}, layer:'DynamicLayer', aspect:'orientation', aspectValue:'landscape'},
	
	{spec:{
		name: 'view5', pos: [0,3], span: [5,8]
	}, layer:'DynamicLayer', aspect:'orientation', aspectValue:'portrait'},
	{spec:{
		name: 'view5', pos: [0,0], span: [8,4]
	}, layer:'DynamicLayer', aspect:'orientation', aspectValue:'landscape'}
];
